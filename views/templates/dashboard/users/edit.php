...
<head>
    ...
    <title>Edit User - PharmaFEFO</title>
...
<div class="flex h-screen w-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header class="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center z-10 flex-shrink-0">
            <div>
                <h2 class="text-xl font-bold text-slate-900 tracking-tight">Modify Operator Profile</h2>
                <p class="text-xs font-semibold text-slate-400 mt-0.5">Update configuration matrices or change authorization thresholds</p>
            </div>
        </header>
        ...
        <main class="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto bg-slate-50/50 space-y-6 flex flex-col items-center">
            ...
            <div class="w-full max-w-xl bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-4 bg-slate-50/70 border-b border-slate-200 flex items-center gap-2.5">
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-slate-900">Account Details Matrix</h3>
                        <p class="text-[10px] font-medium text-slate-400 mt-0.5">Modifying Profile Resource ID #<?= $user->id ?></p>
                    </div>
                </div>
                ...
                <form action="index.php?action=user_update" method="POST" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            <input type="text" name="name"
                                   ...
                                   class="block w-full pl-9 pr-3 py-2 border border-slate-200 bg-white text-slate-900 font-medium text-xs rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                                   placeholder="Update identity label"
                                   required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            <input type="email" name="email"
                                   ...
                                   class="block w-full pl-9 pr-3 py-2 border border-slate-200 bg-white text-slate-900 font-mono text-xs rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                                   placeholder="Update endpoint routing matrix"
                                   required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            <select name="role_id"
                                    ...
                                    required>
                                <option value="" class="text-slate-400">-- Select Access Clearances --</option>
                    ...
                    <div class="flex items-center justify-between border-t border-slate-100 pt-4 mt-2">
                        ...
                        <button type="submit"
                                class="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-bold shadow-sm transition-all">
